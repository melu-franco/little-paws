...
@section('content')
    ...
    <form method="POST" action="{{ route('post.store') }}" enctype="multipart/form-data">
        ...
        <div class="field">
            ...
            <div class="control">
                <textarea class="textarea {{ $errors->has('content') ? 'is-danger' : '' }}" name="content" placeholder="Crear publicación" id="content" cols="30" rows="3"></textarea>
            </div>
    ...
    <div class="tab">
        <button class="tablinks" onclick="openTab(event, 'Latest')">Recientes</button>
        <button class="tablinks" onclick="openTab(event, 'Following')">Siguiendo</button>
    </div>

    @if ($posts->count())

        <div id="Latest" class="tabcontent flex" style="justify-content:space-between;flex-wrap:wrap;align-items: flex-start;">
